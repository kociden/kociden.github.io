const copy = {
  ja: {
    ...
    aboutTitle: '<span class="desktop-title">ゲームを作ったことがなくても、<br />その日に遊べるところまで。</span><span class="mobile-title">ゲームを作ったことが<br />なくても、<br />その日に遊べる<br />ところまで。</span>',
    ...
    partnersBody: "HAGでは、賞金・制作環境・当日の運営を一緒につくるスポンサー、協力団体を募集しています。確定したパートナーはこのページでご紹介します。",
    ...
    visionQuote: "作って終わりじゃない。<br />次のゲームを、一緒に作る仲間と出会う。",
  ...
  en: {
    ...
    heroPrizeLabel: "GRAND PRIZE",
    heroPrizeValue: "JPY 100,000",
    planned: "PLANNED",
    ...
    prize: "JPY 100,000 planned",
    aboutKicker: "WHAT IS HAG?",
    aboutTitle: '<span class="desktop-title">No game-making experience?<br />Make something playable anyway.</span><span class="mobile-title">No experience?<br />Make something<br />playable anyway.</span>',
    ...
    eventKicker: "EVENT",
    eventTitle: "From idea to demo in one day.",
    ...
    partnersBody: "HAG is looking for sponsors and supporting organizations to help fund the prize, production environment, and event operations. Confirmed partners will be featured here.",
    ...
    visionQuote: "More than a finished game.<br />Meet the people you'll build the next one with.",
...
const meta = {
  ...
  en: {
    ...
    description: "HAG is a one-day AI game-making event in Hokkaido on September 19, 2026. Free entry, beginners welcome, and a JPY 100,000 grand prize planned.",
  },
};
